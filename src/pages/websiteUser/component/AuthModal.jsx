...
const AuthModal = ({ isOpen, onClose, onSuccess }) => {
  ...
  const handleSendOtp = async () => {
    ...
    if (!visitorEmail) {
      return setAuthError("Please enter your email");
    }
          ...
          <>
            ...
            <div className="flex justify-between gap-4">
              ...
              <button
                ...
                disabled={loading}
                className={`w-1/2 h-[60px] text-white text-[16px] font-semibold rounded-xl transition ${
                  loading
          ...
          <>
            ...
            <p className="text-md text-orange-500 mb-4 text-center">
              ...
              <span
                ...
                onClick={() => !loading && setAuthStep("email")}
              >
                Edit
              </span>
            </p>
            ...
            <p className="text-sm text-gray-500 text-center mb-4">
              ...
              <span
                className={`cursor-pointer underline ${
                  resendDisabled ? "text-gray-400 cursor-not-allowed" : "text-blue-600"
                }`}
                onClick={() => {
                  if (!resendDisabled && !loading) handleSendOtp();
                }}
              >
                Resend OTP
              </span>
            ...
            <div className="flex justify-between gap-4">
              ...
              <button
                ...
                disabled={loading}
                className={`w-1/2 h-[55px] text-white text-[16px] font-semibold rounded-xl transition ${
                  loading
                    ? "bg-orange-300 cursor-not-allowed"
                    : "bg-orange-500 hover:bg-orange-600"
                }`}
